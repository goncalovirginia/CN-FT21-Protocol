...
public class Node {
	...
	private final int num_interfaces;
	private final Link[] links;
	private final String control_class_name;
	private final String application_class_name;
	...
	private final Queue<Event> inputEvents = new LinkedList<>();
	private final Queue<Event> outputEvents = new LinkedList<>();
	private final GlobalParameters parameters;
	...
	private void process_packet_to_drop(Packet p, int now) {
		String message = "--> node " + node_id + " at " + now + " dropping expired ";
